...
namespace CoTuongLAN.ProgramConfig
{
    public static class Thongso
    {
        ...
        // Tọa độ bàn cờ (TDBC) là tọa độ đơn vị pixel trong winforms
        ...
        public static Point TDBC_Cua_Diem(Point TDDV)
        {
            return TDBC_Cua_Diem(TDDV.X, TDDV.Y);
        }
        ...
        public static Point TDBC_Cua_Quanco(Point TDDV)
        {
            return TDBC_Cua_Quanco(TDDV.X, TDDV.Y);
        }
        ...
        {
            return TDDV_Cua_Diem(TDBC.X, TDBC.Y);
        }
        ...
        public static Point ToaDoQuanCoSangDiem(Point toado_Quanco)
        {
