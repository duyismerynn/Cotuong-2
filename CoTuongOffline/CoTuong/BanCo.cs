...
namespace CoTuongOffline.CoTuong
{
    public static class Banco
    {
        ...
        public static Color Mau_Phedo { get { return Color.DarkRed; } }

        public static Color Mau_Phexanh { get { return Color.DarkBlue; } }
            ...
            for (int y = 0; y < 10; y++)
            {
                for (int x = 0; x < 9; x++)
                {
                    Diem_Banco[x, y] = new ProgramConfig.RoundButton()
                    {
                        ...
                        Location = ProgramConfig.Thongso.TDBC_Cua_Diem(x, y),
        ...
        public static void Tao_Quanco(EventHandler Quanco_Click, PictureBox ptb_Banco)
        {
            if (Mau_Pheta == 2) // phe ta là đỏ
            {
                ...
                // Tướng
                ProgramConfig.RoundPictureBox tuongxanh = new ProgramConfig.RoundPictureBox(ProgramConfig.Thongso_Phedo.Toado_Tuongxanh);
                tuongxanh.Image = global::CoTuongOffline.Properties.Resources.TuongXanh;
                Alive_RoundPictureBox.Add(tuongxanh);

                // Xe
                ProgramConfig.RoundPictureBox xexanh_1 = new ProgramConfig.RoundPictureBox(ProgramConfig.Thongso_Phedo.Toado_Xexanh_1);
                xexanh_1.Image = Properties.Resources.XeXanh;
                Alive_RoundPictureBox.Add(xexanh_1);

                ProgramConfig.RoundPictureBox xexanh_2 = new ProgramConfig.RoundPictureBox(ProgramConfig.Thongso_Phedo.Toado_Xexanh_2);
                xexanh_2.Image = global::CoTuongOffline.Properties.Resources.XeXanh;
                Alive_RoundPictureBox.Add(xexanh_2);

                // Mã
                ProgramConfig.RoundPictureBox maxanh_1 = new ProgramConfig.RoundPictureBox(ProgramConfig.Thongso_Phedo.Toado_Maxanh_1);
                maxanh_1.Image = global::CoTuongOffline.Properties.Resources.MaXanh;
                Alive_RoundPictureBox.Add(maxanh_1);

                ProgramConfig.RoundPictureBox maxanh_2 = new ProgramConfig.RoundPictureBox(ProgramConfig.Thongso_Phedo.Toado_Maxanh_2);
                maxanh_2.Image = global::CoTuongOffline.Properties.Resources.MaXanh;
                Alive_RoundPictureBox.Add(maxanh_2);

                // Tịnh
                ProgramConfig.RoundPictureBox tinhxanh_1 = new ProgramConfig.RoundPictureBox(ProgramConfig.Thongso_Phedo.Toado_Tinhxanh_1);
                tinhxanh_1.Image = global::CoTuongOffline.Properties.Resources.TinhXanh;
                Alive_RoundPictureBox.Add(tinhxanh_1);

                ProgramConfig.RoundPictureBox tinhxanh_2 = new ProgramConfig.RoundPictureBox(ProgramConfig.Thongso_Phedo.Toado_Tinhxanh_2);
                tinhxanh_2.Image = global::CoTuongOffline.Properties.Resources.TinhXanh;
                Alive_RoundPictureBox.Add(tinhxanh_2);

                // Sĩ
                ProgramConfig.RoundPictureBox sixanh_1 = new ProgramConfig.RoundPictureBox(ProgramConfig.Thongso_Phedo.Toado_Sixanh_1);
                sixanh_1.Image = global::CoTuongOffline.Properties.Resources.SiXanh;
                Alive_RoundPictureBox.Add(sixanh_1);

                ProgramConfig.RoundPictureBox sixanh_2 = new ProgramConfig.RoundPictureBox(ProgramConfig.Thongso_Phedo.Toado_Sixanh_2);
                sixanh_2.Image = global::CoTuongOffline.Properties.Resources.SiXanh;
                Alive_RoundPictureBox.Add(sixanh_2);

                // Pháo
                ProgramConfig.RoundPictureBox phaoxanh_1 = new ProgramConfig.RoundPictureBox(ProgramConfig.Thongso_Phedo.Toado_Phaoxanh_1);
                phaoxanh_1.Image = global::CoTuongOffline.Properties.Resources.PhaoXanh;
                Alive_RoundPictureBox.Add(phaoxanh_1);

                ProgramConfig.RoundPictureBox phaoxanh_2 = new ProgramConfig.RoundPictureBox(ProgramConfig.Thongso_Phedo.Toado_Phaoxanh_2);
                phaoxanh_2.Image = global::CoTuongOffline.Properties.Resources.PhaoXanh;
                Alive_RoundPictureBox.Add(phaoxanh_2);

                // Tốt
                ProgramConfig.RoundPictureBox totxanh_1 = new ProgramConfig.RoundPictureBox(ProgramConfig.Thongso_Phedo.Toado_Totxanh_1);
                totxanh_1.Image = global::CoTuongOffline.Properties.Resources.TotXanh;
                Alive_RoundPictureBox.Add(totxanh_1);

                ProgramConfig.RoundPictureBox totxanh_2 = new ProgramConfig.RoundPictureBox(ProgramConfig.Thongso_Phedo.Toado_Totxanh_2);
                totxanh_2.Image = global::CoTuongOffline.Properties.Resources.TotXanh;
                Alive_RoundPictureBox.Add(totxanh_2);

                ProgramConfig.RoundPictureBox totxanh_3 = new ProgramConfig.RoundPictureBox(ProgramConfig.Thongso_Phedo.Toado_Totxanh_3);
                totxanh_3.Image = global::CoTuongOffline.Properties.Resources.TotXanh;
                Alive_RoundPictureBox.Add(totxanh_3);

                ProgramConfig.RoundPictureBox totxanh_4 = new ProgramConfig.RoundPictureBox(ProgramConfig.Thongso_Phedo.Toado_Totxanh_4);
                totxanh_4.Image = global::CoTuongOffline.Properties.Resources.TotXanh;
                Alive_RoundPictureBox.Add(totxanh_4);

                ProgramConfig.RoundPictureBox totxanh_5 = new ProgramConfig.RoundPictureBox(ProgramConfig.Thongso_Phedo.Toado_Totxanh_5);
                ...
                // Tướng
                ProgramConfig.RoundPictureBox tuongdo = new ProgramConfig.RoundPictureBox(ProgramConfig.Thongso_Phedo.Toado_Tuongdo);
                tuongdo.Image = global::CoTuongOffline.Properties.Resources.TuongDo;
                Alive_RoundPictureBox.Add(tuongdo);

                // Xe
                ProgramConfig.RoundPictureBox xedo_1 = new ProgramConfig.RoundPictureBox(ProgramConfig.Thongso_Phedo.Toado_Xedo_1);
                xedo_1.Image = global::CoTuongOffline.Properties.Resources.XeDo;
                Alive_RoundPictureBox.Add(xedo_1);

                ProgramConfig.RoundPictureBox xedo_2 = new ProgramConfig.RoundPictureBox(ProgramConfig.Thongso_Phedo.Toado_Xedo_2);
                xedo_2.Image = global::CoTuongOffline.Properties.Resources.XeDo;
                Alive_RoundPictureBox.Add(xedo_2);

                // Mã
                ProgramConfig.RoundPictureBox mado_1 = new ProgramConfig.RoundPictureBox(ProgramConfig.Thongso_Phedo.Toado_Mado_1);
                mado_1.Image = global::CoTuongOffline.Properties.Resources.MaDo;
                Alive_RoundPictureBox.Add(mado_1);

                ProgramConfig.RoundPictureBox mado2 = new ProgramConfig.RoundPictureBox(ProgramConfig.Thongso_Phedo.Toado_Mado_2);
                mado2.Image = global::CoTuongOffline.Properties.Resources.MaDo;
                Alive_RoundPictureBox.Add(mado2);

                // Tịnh
                ProgramConfig.RoundPictureBox tinhdo_1 = new ProgramConfig.RoundPictureBox(ProgramConfig.Thongso_Phedo.Toado_Tinhdo_1);
                tinhdo_1.Image = global::CoTuongOffline.Properties.Resources.TinhDo;
                Alive_RoundPictureBox.Add(tinhdo_1);

                ProgramConfig.RoundPictureBox tinhdo_2 = new ProgramConfig.RoundPictureBox(ProgramConfig.Thongso_Phedo.Toado_Tinhdo_2);
                tinhdo_2.Image = global::CoTuongOffline.Properties.Resources.TinhDo;
                Alive_RoundPictureBox.Add(tinhdo_2);

                // Sĩ
                ProgramConfig.RoundPictureBox sido_1 = new ProgramConfig.RoundPictureBox(ProgramConfig.Thongso_Phedo.Toado_Sido_1);
                sido_1.Image = global::CoTuongOffline.Properties.Resources.SiDo;
                Alive_RoundPictureBox.Add(sido_1);

                ProgramConfig.RoundPictureBox sido_2 = new ProgramConfig.RoundPictureBox(ProgramConfig.Thongso_Phedo.Toado_Sido_2);
                sido_2.Image = global::CoTuongOffline.Properties.Resources.SiDo;
                Alive_RoundPictureBox.Add(sido_2);

                // Pháo
                ProgramConfig.RoundPictureBox phaodo_1 = new ProgramConfig.RoundPictureBox(ProgramConfig.Thongso_Phedo.Toado_Phaodo_1);
                phaodo_1.Image = global::CoTuongOffline.Properties.Resources.PhaoDo;
                Alive_RoundPictureBox.Add(phaodo_1);

                ProgramConfig.RoundPictureBox phaodo_2 = new ProgramConfig.RoundPictureBox(ProgramConfig.Thongso_Phedo.Toado_Phaodo_2);
                phaodo_2.Image = global::CoTuongOffline.Properties.Resources.PhaoDo;
                Alive_RoundPictureBox.Add(phaodo_2);

                // Tốt
                ProgramConfig.RoundPictureBox totdo_1 = new ProgramConfig.RoundPictureBox(ProgramConfig.Thongso_Phedo.Toado_Totdo_1);
                totdo_1.Image = global::CoTuongOffline.Properties.Resources.TotDo;
                Alive_RoundPictureBox.Add(totdo_1);

                ProgramConfig.RoundPictureBox totdo_2 = new ProgramConfig.RoundPictureBox(ProgramConfig.Thongso_Phedo.Toado_Totdo_2);
                totdo_2.Image = global::CoTuongOffline.Properties.Resources.TotDo;
                Alive_RoundPictureBox.Add(totdo_2);

                ProgramConfig.RoundPictureBox totdo_3 = new ProgramConfig.RoundPictureBox(ProgramConfig.Thongso_Phedo.Toado_Totdo_3);
                totdo_3.Image = global::CoTuongOffline.Properties.Resources.TotDo;
                Alive_RoundPictureBox.Add(totdo_3);

                ProgramConfig.RoundPictureBox totdo_4 = new ProgramConfig.RoundPictureBox(ProgramConfig.Thongso_Phedo.Toado_Totdo_4);
                totdo_4.Image = global::CoTuongOffline.Properties.Resources.TotDo;
                Alive_RoundPictureBox.Add(totdo_4);

                ProgramConfig.RoundPictureBox totdo_5 = new ProgramConfig.RoundPictureBox(ProgramConfig.Thongso_Phedo.Toado_Totdo_5);
            ...
            else if (Mau_Pheta == 1) // phe ta là xanh 
            {
                ...
                // Tướng
                ProgramConfig.RoundPictureBox tuongxanh = new ProgramConfig.RoundPictureBox(ProgramConfig.Thongso_Phexanh.Toado_Tuongxanh);
                tuongxanh.Image = global::CoTuongOffline.Properties.Resources.TuongXanh;
                Alive_RoundPictureBox.Add(tuongxanh);

                // Xe
                ProgramConfig.RoundPictureBox xexanh_1 = new ProgramConfig.RoundPictureBox(ProgramConfig.Thongso_Phexanh.Toado_Xexanh_1);
                xexanh_1.Image = global::CoTuongOffline.Properties.Resources.XeXanh;
                Alive_RoundPictureBox.Add(xexanh_1);

                ProgramConfig.RoundPictureBox xexanh_2 = new ProgramConfig.RoundPictureBox(ProgramConfig.Thongso_Phexanh.Toado_Xexanh_2);
                xexanh_2.Image = global::CoTuongOffline.Properties.Resources.XeXanh;
                Alive_RoundPictureBox.Add(xexanh_2);

                // Mã
                ProgramConfig.RoundPictureBox maxanh_1 = new ProgramConfig.RoundPictureBox(ProgramConfig.Thongso_Phexanh.Toado_Maxanh_1);
                maxanh_1.Image = global::CoTuongOffline.Properties.Resources.MaXanh;
                Alive_RoundPictureBox.Add(maxanh_1);

                ProgramConfig.RoundPictureBox maxanh_2 = new ProgramConfig.RoundPictureBox(ProgramConfig.Thongso_Phexanh.Toado_Maxanh_2);
                maxanh_2.Image = global::CoTuongOffline.Properties.Resources.MaXanh;
                Alive_RoundPictureBox.Add(maxanh_2);

                // Tịnh
                ProgramConfig.RoundPictureBox tinhxanh_1 = new ProgramConfig.RoundPictureBox(ProgramConfig.Thongso_Phexanh.Toado_Tinhxanh_1);
                tinhxanh_1.Image = global::CoTuongOffline.Properties.Resources.TinhXanh;
                Alive_RoundPictureBox.Add(tinhxanh_1);

                ProgramConfig.RoundPictureBox tinhxanh_2 = new ProgramConfig.RoundPictureBox(ProgramConfig.Thongso_Phexanh.Toado_Tinhxanh_2);
                tinhxanh_2.Image = global::CoTuongOffline.Properties.Resources.TinhXanh;
                Alive_RoundPictureBox.Add(tinhxanh_2);

                // Sĩ
                ProgramConfig.RoundPictureBox sixanh_1 = new ProgramConfig.RoundPictureBox(ProgramConfig.Thongso_Phexanh.Toado_Sixanh_1);
                sixanh_1.Image = global::CoTuongOffline.Properties.Resources.SiXanh;
                Alive_RoundPictureBox.Add(sixanh_1);

                ProgramConfig.RoundPictureBox sixanh_2 = new ProgramConfig.RoundPictureBox(ProgramConfig.Thongso_Phexanh.Toado_Sixanh_2);
                sixanh_2.Image = global::CoTuongOffline.Properties.Resources.SiXanh;
                Alive_RoundPictureBox.Add(sixanh_2);

                // Pháo
                ProgramConfig.RoundPictureBox phaoxanh_1 = new ProgramConfig.RoundPictureBox(ProgramConfig.Thongso_Phexanh.Toado_Phaoxanh_1);
                phaoxanh_1.Image = global::CoTuongOffline.Properties.Resources.PhaoXanh;
                Alive_RoundPictureBox.Add(phaoxanh_1);

                ProgramConfig.RoundPictureBox phaoxanh_2 = new ProgramConfig.RoundPictureBox(ProgramConfig.Thongso_Phexanh.Toado_Phaoxanh_2);
                phaoxanh_2.Image = global::CoTuongOffline.Properties.Resources.PhaoXanh;
                Alive_RoundPictureBox.Add(phaoxanh_2);

                // Tốt
                ProgramConfig.RoundPictureBox totxanh_1 = new ProgramConfig.RoundPictureBox(ProgramConfig.Thongso_Phexanh.Toado_Totxanh1_);
                totxanh_1.Image = global::CoTuongOffline.Properties.Resources.TotXanh;
                Alive_RoundPictureBox.Add(totxanh_1);

                ProgramConfig.RoundPictureBox totxanh_2 = new ProgramConfig.RoundPictureBox(ProgramConfig.Thongso_Phexanh.Toado_Totxanh_2);
                totxanh_2.Image = global::CoTuongOffline.Properties.Resources.TotXanh;
                Alive_RoundPictureBox.Add(totxanh_2);

                ProgramConfig.RoundPictureBox totxanh_3 = new ProgramConfig.RoundPictureBox(ProgramConfig.Thongso_Phexanh.Toado_Totxanh_3);
                totxanh_3.Image = global::CoTuongOffline.Properties.Resources.TotXanh;
                Alive_RoundPictureBox.Add(totxanh_3);

                ProgramConfig.RoundPictureBox totxanh_4 = new ProgramConfig.RoundPictureBox(ProgramConfig.Thongso_Phexanh.Toado_Totxanh_4);
                totxanh_4.Image = global::CoTuongOffline.Properties.Resources.TotXanh;
                Alive_RoundPictureBox.Add(totxanh_4);

                ProgramConfig.RoundPictureBox totxanh_5 = new ProgramConfig.RoundPictureBox(ProgramConfig.Thongso_Phexanh.Toado_Totxanh_5);
                totxanh_5.Image = global::CoTuongOffline.Properties.Resources.TotXanh;
                Alive_RoundPictureBox.Add(totxanh_5);
                ...
                ProgramConfig.RoundPictureBox tuongdo = new ProgramConfig.RoundPictureBox(ProgramConfig.Thongso_Phexanh.Toado_Tuongdo);
                tuongdo.Image = global::CoTuongOffline.Properties.Resources.TuongDo;
                Alive_RoundPictureBox.Add(tuongdo);

                // Xe
                ProgramConfig.RoundPictureBox xedo_1 = new ProgramConfig.RoundPictureBox(ProgramConfig.Thongso_Phexanh.Toado_Xedo_1);
                xedo_1.Image = global::CoTuongOffline.Properties.Resources.XeDo;
                Alive_RoundPictureBox.Add(xedo_1);

                ProgramConfig.RoundPictureBox xedo_2 = new ProgramConfig.RoundPictureBox(ProgramConfig.Thongso_Phexanh.Toado_Xedo_2);
                xedo_2.Image = global::CoTuongOffline.Properties.Resources.XeDo;
                Alive_RoundPictureBox.Add(xedo_2);

                // Mã
                ProgramConfig.RoundPictureBox mado_1 = new ProgramConfig.RoundPictureBox(ProgramConfig.Thongso_Phexanh.Toado_Mado_1);
                mado_1.Image = global::CoTuongOffline.Properties.Resources.MaDo;
                Alive_RoundPictureBox.Add(mado_1);

                ProgramConfig.RoundPictureBox mado_2 = new ProgramConfig.RoundPictureBox(ProgramConfig.Thongso_Phexanh.Toado_Mado_2);
                mado_2.Image = global::CoTuongOffline.Properties.Resources.MaDo;
                Alive_RoundPictureBox.Add(mado_2);

                // Tịnh
                ProgramConfig.RoundPictureBox tinhdo_1 = new ProgramConfig.RoundPictureBox(ProgramConfig.Thongso_Phexanh.Toado_Tinhdo_1);
                tinhdo_1.Image = global::CoTuongOffline.Properties.Resources.TinhDo;
                Alive_RoundPictureBox.Add(tinhdo_1);

                ProgramConfig.RoundPictureBox tinhdo_2 = new ProgramConfig.RoundPictureBox(ProgramConfig.Thongso_Phexanh.Toado_Tinhdo_2);
                tinhdo_2.Image = global::CoTuongOffline.Properties.Resources.TinhDo;
                Alive_RoundPictureBox.Add(tinhdo_2);

                // Sĩ
                ProgramConfig.RoundPictureBox sido_1 = new ProgramConfig.RoundPictureBox(ProgramConfig.Thongso_Phexanh.Toado_Sido_1);
                sido_1.Image = global::CoTuongOffline.Properties.Resources.SiDo;
                Alive_RoundPictureBox.Add(sido_1);

                ProgramConfig.RoundPictureBox sido_2 = new ProgramConfig.RoundPictureBox(ProgramConfig.Thongso_Phexanh.Toado_Sido_2);
                sido_2.Image = global::CoTuongOffline.Properties.Resources.SiDo;
                Alive_RoundPictureBox.Add(sido_2);

                // Pháo
                ProgramConfig.RoundPictureBox phaodo_1 = new ProgramConfig.RoundPictureBox(ProgramConfig.Thongso_Phexanh.Toado_Phaodo_1);
                phaodo_1.Image = global::CoTuongOffline.Properties.Resources.PhaoDo;
                Alive_RoundPictureBox.Add(phaodo_1);

                ProgramConfig.RoundPictureBox phaodo_2 = new ProgramConfig.RoundPictureBox(ProgramConfig.Thongso_Phexanh.Toado_Phaodo_2);
                phaodo_2.Image = global::CoTuongOffline.Properties.Resources.PhaoDo;
                Alive_RoundPictureBox.Add(phaodo_2);

                // Tốt
                ProgramConfig.RoundPictureBox totdo_1 = new ProgramConfig.RoundPictureBox(ProgramConfig.Thongso_Phexanh.Toado_Totdo_1);
                totdo_1.Image = global::CoTuongOffline.Properties.Resources.TotDo;
                Alive_RoundPictureBox.Add(totdo_1);

                ProgramConfig.RoundPictureBox totdo_2 = new ProgramConfig.RoundPictureBox(ProgramConfig.Thongso_Phexanh.Toado_Totdo_2);
                totdo_2.Image = global::CoTuongOffline.Properties.Resources.TotDo;
                Alive_RoundPictureBox.Add(totdo_2);

                ProgramConfig.RoundPictureBox totdo_3 = new ProgramConfig.RoundPictureBox(ProgramConfig.Thongso_Phexanh.Toado_Totdo_3);
                totdo_3.Image = global::CoTuongOffline.Properties.Resources.TotDo;
                Alive_RoundPictureBox.Add(totdo_3);

                ProgramConfig.RoundPictureBox totdo_4 = new ProgramConfig.RoundPictureBox(ProgramConfig.Thongso_Phexanh.Toado_Totdo_4);
                totdo_4.Image = global::CoTuongOffline.Properties.Resources.TotDo;
                Alive_RoundPictureBox.Add(totdo_4);

                ProgramConfig.RoundPictureBox totdo_5 = new ProgramConfig.RoundPictureBox(ProgramConfig.Thongso_Phexanh.Toado_Totdo_5);
                totdo_5.Image = global::CoTuongOffline.Properties.Resources.TotDo;
                Alive_RoundPictureBox.Add(totdo_5);
            }
        ...
        public static void Write_PheDuocDanh(Label lbl_PheDuocDanh)
        {
            if (PheDuocdanh == 2)
            {
                ...
                lbl_PheDuocDanh.Text = "Lượt đi của phe Đỏ";
            }
            else
            {
                lbl_PheDuocDanh.ForeColor = Mau_Phexanh;
                lbl_PheDuocDanh.Text = "Lượt đi của phe Xanh";
            }
        }
        ...
        public static void Hienthi_Diemdich() // Hiển thị tập hợp điểm đích
        {
            ...
            Quanco_Duocchon.Quanco.TinhNuocDi();
        ...
        {
            Nuocdi_Truoc.PrevGreyTargetDepartureLocation = GreyTargetDeparture.Location;
            Nuocdi_Truoc.PrevGreyTargetDestinationLocation = GreyTargetDestination.Location;
            GreyTargetDeparture.Location = new Point(ProgramConfig.Thongso.TDBC_Cua_Quanco(departure).X + 10, ProgramConfig.Thongso.TDBC_Cua_Quanco(departure).Y + 10);
            GreyTargetDestination.Location = new Point(ProgramConfig.Thongso.TDBC_Cua_Quanco(destination).X - 1, ProgramConfig.Thongso.TDBC_Cua_Quanco(destination).Y - 1);
            if (So_Luotdi == 0)
            {
        ...
        {
            Nuocdi_Truoc.ToaDoDi = new Point(departure.X, departure.Y);
            Nuocdi_Truoc.ToaDoDen = new Point(destination.X, destination.Y);
            Nuocdi_Truoc.QuanCoDiChuyen = Quanco_Duocchon;
            Nuocdi_Truoc.QuanCoBiLoai = Quanco_Biloai;
        }

        public static void Hoantac(PictureBox ptb_Banco)
        {
            Nuocdi_Truoc.QuanCoDiChuyen.DiChuyen(Nuocdi_Truoc.ToaDoDi);
            TraLaiQuanCo(ptb_Banco, Nuocdi_Truoc.QuanCoBiLoai);
        }
